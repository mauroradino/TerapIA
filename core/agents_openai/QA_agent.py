...
QA_agent = Agent(
    ...
    tools=[set_reminder, update_user_info, send_telegram_message, send_email, search_emergency_contacts, confirm_emergency_contact, send_emergency_message, check_emergency_contact_status],
)
