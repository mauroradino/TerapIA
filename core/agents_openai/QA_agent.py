...
QA_agent = Agent(
    ...
    tools=[set_reminder, update_user_info, send_telegram_message, send_email, search_emergency_contacts, confirm_emergency_contact, set_emergency_contact, get_current_user_telegram_id],
)
